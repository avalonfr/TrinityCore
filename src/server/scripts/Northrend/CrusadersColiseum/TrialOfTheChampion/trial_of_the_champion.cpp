...
#define GOSSIP_START_EVENT1 "Je suis prêt à commencer le défi."
#define GOSSIP_START_EVENT2 "Je suis prêt pour le prochain défi."
#define GOSSIP_START_EVENT3 "Faisons face à notre dernier défi."
