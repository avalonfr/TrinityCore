...
public:
    ...
    class spell_gen_shieldbreaker_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_gen_shieldbreaker_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    ...
    class spell_gen_atcharge_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_gen_atcharge_SpellScript::HandleScript, EFFECT_2, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
...
public:
    ...
    class spell_gen_npcshieldbreaker_SpellScript : public SpellScript
    {
        ...
        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_gen_npcshieldbreaker_SpellScript::HandleScript, EFFECT_1, SPELL_EFFECT_SCRIPT_EFFECT);
        }
    };
