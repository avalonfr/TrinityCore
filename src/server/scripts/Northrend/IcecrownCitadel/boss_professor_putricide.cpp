...
class npc_volatile_ooze : public CreatureScript
{
    public:
        ...
        struct npc_volatile_oozeAI : public ScriptedAI
        {
			...
			{
				Ptarget = Player::GetPlayer(*me,Tguid);
				Tchase = 0;
				Start_Chase = true;
			}
    ...
    public:
        ...
        class spell_putricide_ooze_channel_SpellScript : public SpellScript
        {
            ...
            void StartAttack()
            {
                ...
                GetCaster()->ToCreature()->AI()->AttackStart(GetHitPlayer());

				GetCaster()->ToCreature()->SetUnitMovementFlags(MOVEMENTFLAG_WALKING);
				GetCaster()->ToCreature()->AI()->SetGUID(GetHitUnit()->GetGUID());
            }
