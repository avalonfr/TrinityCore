...
enum DataTypes
{
	...
	// For Gunship
    DATA_FIRST_SQUAD_STATE                  = 53,
    DATA_SECOND_SQUAD_STATE                 = 54,
    DATA_SPIRE_FROSTWYRM_STATE              = 55,
    DATA_GB_HIGH_OVERLORD_SAURFANG          = 56,
    DATA_GB_MURADIN_BRONZEBEARD             = 57,
    DATA_HIGH_OVERLORD_SAURFANG_NOT_VISUAL  = 58,
    DATA_GB_BATTLE_MAGE                     = 59,
    DATA_SKYBREAKER_BOSS                    = 60,
    DATA_ORGRIMMAR_HAMMER_BOSS              = 61,
    DATA_MURADIN_BRONZEBEARD_NOT_VISUAL     = 62,

    // misc
    DATA_MURADIN_BRONZEBEARD        = 63,
    DATA_GUNSHIP_BATTLE             = 64,
    GUID_PLAYER_LOCATION            = 65,

	//OTHERS
	DATA_SINDRAGOSA_GAUNTLET        = 66,
