...
{
    public:
		WorldSession(uint32 id, WorldSocket* sock, AccountTypes sec, bool isVIP, uint8 expansion, time_t mute_time, LocaleConstant locale, uint32 recruiter, bool isARecruiter);
        ~WorldSession();
		...
		bool IsVIP() const { return _isVIP; }
