...
WorldSession::WorldSession(uint32 id, WorldSocket* sock, AccountTypes sec, bool isVIP, uint8 expansion, time_t mute_time, LocaleConstant locale, uint32 recruiter, bool isARecruiter):
m_muteTime(mute_time), m_timeOutTime(0), _player(NULL), m_Socket(sock),
_security(sec), _isVIP(isVIP), _accountId(id), m_expansion(expansion), _logoutTime(0),
