...
(50004, 0, 0, 'Ce n\'est pas votre combat, Nain. Arrière ou nous serons obligés de détruire votre vaisseau.', 14, 0, 0, 0, 0, 17093, ''),
(50006, 1, 0, 'Marines! Sergents! Attaquez!', 14, 0, 0, 0, 0, 16956, ''),
(50006, 0, 0, 'Déplacez votre tacot ou nous allons le faire monter au ciel, Orc! La Horde n\'a rien à faire ici!', 14, 0, 0, 0, 0, 16969, '');
...
(@MURADIN,  0, 0, "Faites chauffer les moteurs on a rancard avec le DESTIN les gars!", 14, 0, 100, 0, 0, 16962, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_0'),
(@MURADIN,  1, 0, "Accrochez vous a vos casques", 14, 0, 100, 0, 0, 16963, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_1'),
(@MURADIN,  2, 0, "Qu est ce que c est que ce truc equipage ma longue vue FISSA!", 14, 0, 100, 0, 0, 16964, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_2'),
(@MURADIN,  3, 0, "Par ma barbe! Horde en approche! Et pas qu a moitié!", 14, 0, 100, 0, 0, 16965, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_3'),
(@MURADIN,  4, 0, "MANOEUVRE D ESQUIVE!TOUS A VOS CANONS!", 14, 0, 100, 0, 0, 16966, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_4'),
(@MURADIN,  5, 0, "Pleutres a foies jaunes!Vous attaquez par l angle mort", 14, 0, 100, 0, 0, 16967, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_5'),
(@MURADIN,  6, 0,  "Pas mon combat!Mon gars chait pas pourqui tu te prends mais j ai un compte a regler avec ARTHAS et vous allez pas vous mettre sur mon chemin!FEU A VOLONTE!FEU!FEU", 14, 0, 100, 0, 0, 16968, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_7'),
(@MURADIN,  7, 0, "Bougez moi votre rafiotd de là ou on vous descend ORC!La horde n a rien a fiche ici! ", 14, 0, 100, 0, 0, 16969, 'Muradin Bronzebeard - SAY_INTRO_HORDE_3'),
(@MURADIN,  8, 0, "Et puis quoi encore chuit un fils de Forgefer!je vais pas vous laisser mon vaisseau sans me battre!", 14, 0, 100, 0, 0, 16958, 'Muradin Bronzebeard - SAY_BOARDING_SKYBREAKER_1'),
(@MURADIN,  9, 0, "Soldat Sergent A L ATTAQUE", 14, 0, 100, 0, 0, 16956, 'Muradin Bronzebeard - SAY_BOARDING_ORGRIMS_HAMMER_0'),
(@MURADIN, 10, 0, "Fusilliers accelere le tir", 14, 0, 100, 0, 0, 16954, 'Muradin Bronzebeard - SAY_NEW_RIFLEMEN_SPAWNED'),
(@MURADIN, 11, 0, "Mortier on recharge!", 14, 0, 100, 0, 0, 16955, 'Muradin Bronzebeard - SAY_NEW_MORTAR_TEAM_SPAWNED'),
(@MURADIN, 12, 0, "La coque deguste severe qu un sorcier aille me fairre taire ces canons!", 14, 0, 100, 0, 0, 16957, 'Muradin Bronzebeard - SAY_NEW_MAGE_SPAWNED'),
(@MURADIN, 13, 0, "Vous ne direz pas que je vous ai pas prevenu canailles !Mes freres et soeur en AVANT!", 14, 0, 100, 0, 0, 16959, 'Muradin Bronzebeard - SAY_ALLIANCE_VICTORY'),
(@MURADIN, 14, 0, "Captain Bartlett, Degagez nous de là!On a pris trop de degats pour rester en l air", 14, 0, 100, 0, 0, 16960, 'Muradin Bronzebeard - SAY_ALLIANCE_DEFEAT'),
(@OVERLORD, 0, 0, "Levez vous fils et filles de la horde! Aujourd hui nous affrontons le plus hai de nos ennemis! LOK""TAR OGAR!", 14, 0, 100, 0, 0, 17087, 'High Overlord Saurfang - SAY_INTRO_HORDE_0'),
(@OVERLORD, 1, 0, "Kor Kron Appareillez", 14, 0, 100, 0, 0, 17088, 'High Overlord Saurfang - SAY_INTRO_HORDE_1_1'),
...
(@OVERLORD, 4, 0, "Nous allons voir qui bougeras! KOR""KRON, ANNEANTISSEZ LES!", 14, 0, 100, 0, 0, 17092, 'High Overlord Saurfang - SAY_INTRO_HORDE_4'),
(@OVERLORD, 5, 0, "Saccageurs,Sergent, A l ATTAQUE!", 14, 0, 100, 0, 0, 17081, 'High Overlord Saurfang - SAY_BOARDING_SKYBREAKER_0'),
(@OVERLORD, 6, 0, "Vous osez ABORDER mon vaisseau ! Votre mort sera rapide.", 14, 0, 100, 0, 0, 17083, 'High Overlord Saurfang - SAY_BOARDING_ORGRIMS_HAMMER_1'),
(@OVERLORD, 7, 0, "Lanceur de Hache ,Augmentez la cadence!", 14, 0, 100, 0, 0, 17079, 'High Overlord Saurfang - SAY_NEW_AXETHROWER_SPAWNED'),
(@OVERLORD, 8, 0, "Missiliers on rechage!", 14, 0, 100, 0, 0, 17080, 'High Overlord Saurfang - SAY_NEW_ROCKETEERS_SPAWNED'),
(@OVERLORD, 9, 0, "La coque est endommagée,qu un mage de bataille aille faire taire leur canons ", 14, 0, 100, 0, 0, 17082, 'High Overlord Saurfang - SAY_NEW_BATTLE_MAGE_SPAWNED'),
(@OVERLORD, 10, 0, "L alliance baisses pavillon,SUS au roi Liche", 14, 0, 100, 0, 0, 17084, 'High Overlord Saurfang - SAY_HORDE_VICTORY'),
(@OVERLORD, 11, 0, "Soldat du feu Eteignez cet incendie!la horde n a pas dit son dernier mot!", 14, 0, 100, 0, 0, 17085, 'High Overlord Saurfang - SAY_HORDE_DEFEAT'),
(@OVERLORD, 12, 0, 'Ce n\'est pas votre combat, Nain. Arrière ou nous serons obligés de détruire votre vaisseau.', 14, 0, 100, 0, 0, 17093, 'High Overlord Saurfang - SAY_INTRO_ALLIANCE_6'),
(@PRIMALIST,0, 0, 'Merci mes frères et sœurs. Le Brise-ciel a déjà fui. Vite, au Marteau d\'Ogrim! Si vous partez vite, vous pourrez peut-être les rattraper.', 12, 0, 100, 0, 0, @SOUNDID, 'Kor''kron Primalist - SAY_FIRST_SQUAD_RESCUED_HORDE_0'),
...
(@DEFENDER, 1, 0, 'Le capitaine Saurfang se fera un plaisir de vous voir à bord du Marteau d\'Orgrim. Hâtez-vous, nous allons sécuriser la zone jusqu\'à ce que vous êtes prêt pour le décollage.', 12, 0, 100, 0, 0, @SOUNDID, 'Kor''kron Defender - SAY_SECOND_SQUAD_RESCUED_HORDE_1'),
(@DEFENDER, 2, 0, 'Un cri strident perce l\'air au-dessus!',41, 0, 100, 0, 0, @SOUNDID, 'Frostwyrm - SAY_FROSTWYRM_SUMMON_0'),
(@VINDICATOR, 0, 0, 'Dieu merci, vous êtes arrivé qu\'avez vous fait, les héros du Marteau d\'Orgrim sont déja partit. Vite, sur le Brise-ciel! Si vous partez bientôt, vous pourrez peut-être pour les rattraper.', 12, 0, 100, 0, 0, @SOUNDID, 'Skybreaker Vindicator - SAY_FIRST_SQUAD_RESCUED_ALLIANCE_0'),
...
(@PROTECTOR,0, 0, 'Vous avez tous mes remerciements. Nous avons jamais été aussi nombreux jusqu\'à ce que vous arrivez.', 12, 0, 100, 0, 0, @SOUNDID, 'Skybreaker Protector - SAY_SECOND_SQUAD_RESCUED_ALLIANCE_0'),
(@PROTECTOR,1, 0, 'Le capitaine Muradin vous attend à bord du Brise-ciel. Nous allons sécuriser la zone jusqu\'à ce que vous êtes prêt pour le décollage.', 12, 0, 100, 0, 0, @SOUNDID, 'Skybreaker Protector - SAY_SECOND_SQUAD_RESCUED_ALLIANCE_1'),
