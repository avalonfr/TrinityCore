...
(@MURADIN,  1, 0, 'Accrochez-vous à vos chapeaux!', 14, 0, 100, 0, 0, 16963, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_1'),
(@MURADIN,  2, 0, 'Dans quel monde vivons nous? Prenez-moi membre d\'équipage!', 14, 0, 100, 0, 0, 16964, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_2'),
...
(@MURADIN,  5, 0, 'Chiens lâches! Vous nous aveuglés!', 14, 0, 100, 0, 0, 16967, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_5'),
(@MURADIN,  6, 0, 'Ce n\'est pas ma bataille? Vous ne savez pas qui nous sommes, Monsieur, mais j\'ai un compte à régler avec Arthas'' Qu\'il en soit ainsi! FEU TOUTES ARMES DEHORS! FEU! FEU!', 14, 0, 100, 0, 0, 16968, 'Muradin Bronzebeard - SAY_INTRO_ALLIANCE_7'),
(@MURADIN,  7, 0, 'Déplacez votre tacot ou nous allons le faire monter au ciel, Orc! La Horde n\'a rien à faire ici!', 14, 0, 100, 0, 0, 16969, 'Muradin Bronzebeard - SAY_INTRO_HORDE_3'),
...
(@MURADIN, 11, 0, 'Équipe de mortier, rechargez!', 14, 0, 100, 0, 0, 16955, 'Muradin Bronzebeard - SAY_NEW_MORTAR_TEAM_SPAWNED'),
(@MURADIN, 12, 0, 'Nous prenons des dommages sur la coque, Trouvez un sorcier pour arrêter ces canons!', 14, 0, 100, 0, 0, 16957, 'Muradin Bronzebeard - SAY_NEW_MAGE_SPAWNED'),
(@MURADIN, 13, 0, 'Ne me dites pas que je ne vous avais pas prévenu, canailles! En avant, frères et sœurs!', 14, 0, 100, 0, 0, 16959, 'Muradin Bronzebeard - SAY_ALLIANCE_VICTORY'),
(@MURADIN, 14, 0, 'Le capitaine Bartlett va nous sortir d\'ici! Nous prenons trop de dégâts pour rester à flot!', 14, 0, 100, 0, 0, 16960, 'Muradin Bronzebeard - SAY_ALLIANCE_DEFEAT'),
(@OVERLORD, 0, 0, 'Lève-toi, fils et filles de la Horde! Aujourd\'hui, nous nous battons contre un ennemi haï de la Horde! LOK'' TAR OGAR!', 14, 0, 100, 0, 0, 17087, 'High Overlord Saurfang - SAY_INTRO_HORDE_0'),
...
(@OVERLORD, 4, 0, 'Vous saurez bientôt notre projet! KOR'' KRON, anéantit les!', 14, 0, 100, 0, 0, 17092, 'High Overlord Saurfang - SAY_INTRO_HORDE_4'),
...
(@OVERLORD, 8, 0, 'Ingénieurs rechargez moi ces Rockets', 14, 0, 100, 0, 0, 17080, 'High Overlord Saurfang - SAY_NEW_ROCKETEERS_SPAWNED'),
(@OVERLORD, 9, 0, 'Nous prenons des dommages sur la coque, Trouvez un sorcier pour arrêter ces canons!', 14, 0, 100, 0, 0, 17082, 'High Overlord Saurfang - SAY_NEW_BATTLE_MAGE_SPAWNED'),
(@OVERLORD, 10, 0, 'L\'Alliance faiblit. En route pour le roi-liche!', 14, 0, 100, 0, 0, 17084, 'High Overlord Saurfang - SAY_HORDE_VICTORY'),
(@OVERLORD, 11, 0, 'Contolez les dégats, Eteignez moi ce feu. Vous n\'avez pas vu la fin de la Horde', 14, 0, 100, 0, 0, 17085, 'High Overlord Saurfang - SAY_HORDE_DEFEAT'),
