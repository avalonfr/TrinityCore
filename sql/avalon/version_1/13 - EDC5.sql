DELETE FROM `spell_script_names` WHERE spell_id IN (66515, 66867, 67534, 67830, 66482,66862,67681);
...
INSERT INTO `npc_spellclick_spells` (`npc_entry`, `spell_id`, `cast_flags`) VALUES (35427, 46598, 1);
...
VALUES (0, 35004, 650, 3, 1, 0, 0, 747.014, 619.459, 411.09, 4.74455, 300, 0, 0, 10635, 0, 0, 0, 0, 0);